...
retriever = neo4jVector.as_retriever(search_type="mmr", search_kwargs={"k": 6, "lambda_mult": 0.25})
...
agent = Agent(
    model=Ollama(id="llama3.2"), knowledge_base=knowledge_base, use_tools=True, show_tool_calls=True, markdown=True
)
